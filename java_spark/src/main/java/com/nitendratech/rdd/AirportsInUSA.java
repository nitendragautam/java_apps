 ...
 * Command:
 *
 * $SPARK_HOME/bin/spark-submit --class "com.nitendratech.rdd.AirportsInUSA" --master "local[2]" ./target/javaspark-1.0.jar ./datasets/airports.text
 **
 *local[2]: 2 cores
